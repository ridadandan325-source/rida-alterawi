            ...
            <form method="POST" action="{{ route('password.confirm') }}">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <x-text-input id="password" class="form-control border-start-0 ps-2" type="password" name="password" required autocomplete="current-password" />
                    </div>
                ...
                <div class="mb-4">
                    <button type="submit" class="btn w-100 fw-bold py-3 text-white border-0 shadow-lg btn-primary hover-scale rounded-pill d-flex align-items-center justify-content-center gap-2">
                        <span>Confirm</span> <i class="fas fa-check-circle small"></i>
                    </button>
                </div>
            </form>
        </div>
